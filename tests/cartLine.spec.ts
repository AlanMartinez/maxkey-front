...
const product = { slug: 'riot-points', name: 'Riot Points', imageUrl: 'https://cdn/x.png' }
...
describe('cartLine helpers', () => {
  ...
  it('falls back to the single catalog image when the gallery list is absent or empty', () => {
